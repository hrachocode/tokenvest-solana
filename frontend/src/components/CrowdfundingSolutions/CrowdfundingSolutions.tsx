...
const CrowdfundingSolutions = () => {
  ...
  return (
    <section id="section-to" ref={animationRef} className='secondaryFlex w-full flex-col relative text-center p-[90px_60px_145px_60px]'>
      {
        isVisible &&
        <div className={`relative ${isVisible ? "animationDropDown" : ""}`}>
      ...
      {
        isVisible && <div className="primaryFlex relative animationClimbUp flex-wrap lg:flex-nowrap gap-[10px] z-10">
