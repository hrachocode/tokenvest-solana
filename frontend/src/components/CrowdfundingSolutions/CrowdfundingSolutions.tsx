...
const CrowdfundingSolutions = () => {
  ...
  return (
    <section className='secondaryFlex w-full flex-col relative text-center p-[90px_60px_145px_60px]'>
      <div className={`relative ${isVisible ? "animationDropDown" : ""}`} ref={animationRef}>
      ...
      <div className={`primaryFlex relative ${isVisible ? "animationClimbUp" : ""} flex-wrap lg:flex-nowrap gap-[10px] z-10`}>
