...
import { AUTH_FORGOT_PASSWORD, AUTH_SIGN_IN, AUTH_SIGN_IN_ERROR, AUTH_SIGN_IN_SUCCESS, AUTH_SIGN_UP, AUTH_SUCCESS_VERIFACATION, CREATE_ACCOUNT } from "../../constants/auth";
  ...
  const handleSignIn = async (event: FormEvent) => {
    ...
    try {
      ...
      if (signInResponse.error) {
        ...
        return;
      } else if (signInResponse.jwt && signInResponse.user) {
        localStorage.setItem("jwtToken", signInResponse.jwt);
